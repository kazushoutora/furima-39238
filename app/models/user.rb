class User < ApplicationRecord
  ...
  validates :first_name,         presence: true, format: { with: /\A[一-龯ぁ-んァ-ヶー－]+\z/, message: "は漢字・ひらがな・カタカナで入力してください" }
  validates :last_name,          presence: true, format: { with: /\A[一-龯ぁ-んァ-ヶー－]+\z/, message: "は漢字・ひらがな・カタカナで入力してください" }
